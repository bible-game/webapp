...
const Heatmap = (props: any) => {
    ...
    return (
        <section className="flex flex-wrap sm:w-[48rem] w-[80vw] pb-12">
            {Object.values(props.data).map((data: any) => <div className="p-0 flex flex-wrap" key={data.book}>
                <p className="font-extralight text-[10px] w-full pb-1 pt-2 opacity-80">{data.pretty}</p>
