...
const Treemap = (props: any) => {
    ...
    return (
            //@ts-ignore
            <div ref={element} className="absolute w-full sm:w-[44rem] h-[calc(100%-26rem)] sm:h-[calc(100%-16.5rem)] left-0 sm:left-[calc(50%-22rem)] top-[10.25rem] sm:top-[7.5rem]" id="treemap"></div>
    );
};
