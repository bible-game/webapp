...
const Guesses = (props: any) => {
    ...
    return <section className="w-full left-0 px-4 flex justify-center flex-wrap gap-4 mt-0 sm:mt-4 absolute sm:bottom-[1.5rem] sm:py-0 py-2 pointer-events-auto">
